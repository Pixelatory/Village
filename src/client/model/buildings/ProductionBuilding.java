...
/**
 * General abstract class that encompasses everything a building should do/have if it contains workers, and generates client.model.resources.
 * 
 * @param <E> extends ProductionHabitant
 * @author 6177000
 * @see Building
 * @see client.model.habitants.ProductionHabitant
