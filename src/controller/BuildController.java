 ...
 * BuildController
 *
 * A controller that only applies when the game is in a construct building state
 *
    ...
    protected static void execute(GameContainer gc, Model model, View view) {
        if(Controller.rightClickUp(gc)) { // RIGHT CLICK IN BUILD MODE
            ...
            if(model.getSelectedNewConstruction() != null) { // BUILDING WAS ALREADY SELECTED
                ...
                if(Controller.mouseInBounds(view.getCannonSymbol())
                ...
                if(Controller.mouseInBounds(view.getFarmSymbol())) {
                ...
                if(Controller.mouseInBounds(view.getGoldMineSymbol())) {
                ...
                if(Controller.mouseInBounds(view.getIronMineSymbol())) {
                ...
                if(Controller.mouseInBounds(view.getLumbermillSymbol())) {
